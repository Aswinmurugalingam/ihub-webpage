...
export default function Pricing(){return <>
  ...
  <section style={{padding:'0 0 96px'}}><div className="container"><CtaBanner title={<>Ready to repair? <span className="brand-text">Book or request pickup.</span></>} sub="Book a store visit or use free pickup & delivery for eligible mobile-phone repairs." btn1Text="Schedule Free Pickup" btn1Link="/booking?method=pickup" btn2Text="WhatsApp Quote" btn2Link="https://wa.me/919025790266?text=Hi%2C%20I%20need%20an%20exact%20repair%20quote"/></div></section>
</>}
