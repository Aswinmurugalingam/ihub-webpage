...
export default function Footer(){
  ...
  return <footer className={styles.footer}><div className="container"><div className={styles.grid}>
    <div className={styles.brand}><Link to="/"><img src={logoImg} alt="iHub Nagercoil" className={styles.logoImg}/></Link><p className={styles.brandText}>Professional multi-brand device repair in Nagercoil, with transparent diagnosis, quality-focused repair and convenient pickup & delivery for supported devices.</p>
    </div>
    <div><div className={styles.colTitle}>Repair</div><ul className={styles.linkList}><li><Link to="/services" className={styles.footLink}>All Services</Link></li><li><Link to="/pickup-delivery#book-repair" className={styles.footLink}>Book Repair</Link></li><li><Link to="/pickup-delivery" className={styles.footLink}>Free Pickup & Delivery</Link></li></ul></div>
